...
class UserValidate extends Validate
{
    ...
    protected $scene = [
        ...
        'add' => ['username', 'nickname', 'password', 'phone', 'email', 'power_grade'],
        'edit' => ['user_id', 'username', 'nickname', 'phone', 'email', 'power_grade'],
        'del' => ['ids'],
        'pwd' => ['ids', 'password'],
        'super' => ['ids'],
        'disable' => ['ids'],

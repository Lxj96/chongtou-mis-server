...
use app\common\lib\enum\FileEnum;
use Qiniu\Auth;
        ...
        try {
            ...
            if ($storage == 'qiniu') {
                ...
                if ($err !== null) {
                    ...
                    throw new UploadErrorException($msg);
                }
                else {
            ...
            elseif ($storage == 'aliyun') {
                ...
                // 设置文件名称。
                $object = config('filesystem.file_catalogue') . $file_info['file_hash'] . '.' . $file_info['file_ext'];

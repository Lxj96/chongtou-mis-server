...
namespace app\common\service\currency;


use app\common\cache\currency\FileCache;
use app\common\cache\currency\FileGroupCache;
use app\common\exception\SaveErrorMessage;
use app\common\exception\UploadErrorException;
use app\common\model\currency\FileGroupModel;
...
//        $ids = array_column($list, $pk);
    ...
    public static function add($param)
    {
        ...
        $file_name = Filesystem::disk('public')
            ->putFile('currency_file', $file, function () use ($file_hash) {
                return $file_hash;
            });

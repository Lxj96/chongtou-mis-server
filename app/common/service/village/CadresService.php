...
/**
 * Description: 专职队伍
 * File: CadresService.php
 * User: Lxj
 * DateTime: 2022-11-13 11:13
 */
...
use app\common\model\village\CadresModel;
...
class CadresService
{
    ...
    public static function list($where = [], $current = 1, $pageSize = 10, $order = [], $field = '')
    {
        ...
        if (empty($field)) {
            $field = 'id,village_id,organization,name,duties,address,phone,remark,create_time,update_time';
        }
